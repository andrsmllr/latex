...
%
% The xcolor package provides ways to define custom colors.
%
\usepackage{xcolor}
...
%
% The listings package provides ways to include source code into a document.
%
\usepackage{listings}
...
%
% Create new commands to ease use of listings with custom styles and captions.
%
...
\lstinputlisting[language=VHDL, frame=single, firstline=3, lastline=12]{test.vhdl}~\\

\paragraph{Use a custom style for source code formatting}
Styles can be customized as desired.
\lstinputlisting[language=c, style=customc]{test.c}~\\
